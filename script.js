...
const worksheet = workbook.Sheets[targetSheetName];
        ...
        // 🔑 Reemplaza la primera celda sin importar si tiene rowspan o colspan
        const styledHtml = htmlTableRaw
            ...
            .replace(/<tr>\s*<td[^>]*>.*?<\/td>/s, '<tr><td style="border: 1px solid #000; text-align: center; vertical-align: middle; padding: 4px;"><img src="logo.jpg" alt="Logo Agromar" style="max-height: 35px; width: auto; display: block; margin: 0 auto;" /></td>');
        // Mostrar en pantalla
        const container = document.getElementById('kardex-excel-table-container');
        if (container) {
